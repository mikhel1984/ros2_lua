...
OBJ_SEQ_DO_RESIZE(uint8)
OBJ_SEQ_RESIZE (uint8)
...
OBJ_SEQ_DO_RESIZE(int16)
OBJ_SEQ_RESIZE (int16)
...
OBJ_SEQ_DO_RESIZE(uint16)
OBJ_SEQ_RESIZE (uint16)
...
OBJ_SEQ_DO_RESIZE(int32)
OBJ_SEQ_RESIZE (int32)
...
OBJ_SEQ_DO_RESIZE(uint32)
OBJ_SEQ_RESIZE (uint32)
...
OBJ_SEQ_DO_RESIZE(int64)
OBJ_SEQ_RESIZE (int64)
...
OBJ_SEQ_DO_RESIZE(uint64)
OBJ_SEQ_RESIZE (uint64)
